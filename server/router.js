...
const router = (app, mode = 'dev')=> {
  ...
  app.get('/signup-datas/:turn_id', authorize, blocked, SignupDataController.exportSignupData);
  ...
  app.post('/send-message', authorize, blocked, UserturnController.sendMessage);
